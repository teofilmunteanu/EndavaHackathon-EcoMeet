          ...
          >
            ...
            >
              ...
              <Box w="90%" h="50%" ml= "10" mr="100" bgGradient="linear(180deg, rgba(255, 254, 254, 0.38) 0%, rgba(255, 245, 0, 0.304) 100%)" boxShadow="0px 4px 4px rgba(0, 0, 0, 0.25)" borderRadius="5px">
                <input fontSize='2em' size="md" type="file" name="cv" id="files" placeholder="document.PDF" accept="application/pdf" required />
              </Box>
            </GridItem>
            <GridItem
              colSpan={1}
            ...
            >
              ...
              <Accordion allowToggle backgroundColor="#F1FFF4" overflowX="auto">
                {feed.map((feed) => {
                  return (
